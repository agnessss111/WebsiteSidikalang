...
<header class="masthead">
	<div class="container">
		...
		<div class="masthead-heading text-uppercase">Sidikalang Kabupaten Dairi</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">view</a>
	</div>
</header>
<!-- Services-->
<section class="page-section bg-dark" id="home">
	...
	<div class="row">
		...
		?>
			<div class="col-md-4 p-4 ">
				...
				<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning"><img class="card-img-top" src="<?php echo validate_image($cover) ?>" alt="<?php echo $row['title'] ?>" height="200rem" style="object-fit:cover"></a>
					<div class="card-body">
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=packages" class="btn btn-flat btn-warning mr-4">Lihat Selengkapnya<i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
...
<section class="page-section bg-dark" id="home">
	...
	<div class="row">
		<?php
		$packages = $conn->query("SELECT * FROM `informasi` order by rand() limit 3");
			while($row = $packages->fetch_assoc() ):
				$cover='';
		...
		?>
			<div class="col-md-4 p-4 ">
				<div class="card w-100 rounded-0">
				<a href="./?page=view_book&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning"><img class="card-img-top" src="<?php echo validate_image($cover) ?>" alt="<?php echo $row['title'] ?>" height="200rem" style="object-fit:cover"></a>
					<div class="card-body">
					<h5 class="card-title truncate-1 w-100"><?php echo $row['title'] ?></h5><br>
					<div class=" w-100 d-flex justify-content-start">
						<div class="stars stars-small">
...
<section class="page-section bg-dark" id="home">
	...
	<div class="row">
		<?php
		$packages = $conn->query("SELECT * FROM `penghasilan` order by rand() limit 3");
			while($row = $packages->fetch_assoc() ):
				$cover='';
		...
		?>
			<div class="col-md-4 p-4 ">
				<div class="card w-100 rounded-0">
				<a href="./?page=view_review&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning"><img class="card-img-top" src="<?php echo validate_image($cover) ?>" alt="<?php echo $row['title'] ?>" height="200rem" style="object-fit:cover"></a>
					<div class="card-body">
					<h5 class="card-title truncate-1 w-100"><?php echo $row['title'] ?></h5><br>
					<div class=" w-100 d-flex justify-content-start">
						<div class="stars stars-small">
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=review" class="btn btn-flat btn-warning mr-4">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
