...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `penghasilan` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
	...
	<div class="card-body">
		<form action="" id="package-form">
			...
			<div class="form-group">
				<label for="title" class="control-label">Penghasilan</label>
                <textarea name="title" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
			</div>
            <div class="form-group">
				<label for="tour_location" class="control-label">Lokasi</label>
